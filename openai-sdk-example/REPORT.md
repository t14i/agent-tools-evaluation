...
|----------|-------|---------------|-----------------|-------|
| TC (5) | 5 | 5 | 0 | Tool definition excellent, Pydantic native |
| HI (5) | 5 | 3 | 2 | Approval via callbacks, timeout/notification custom |
| DU (6) | 6 | 4 | 2 | Sessions API solid, cleanup/concurrency custom |
| ME (8) | 8 | 4 | 4 | Basic memory OK, agent autonomous mgmt missing |
| MA (5) | 5 | 4 | 1 | Native handoffs excellent |
| GV (6) | 6 | 2 | 4 | Guardrails available, policy/audit custom |
| DR (6) | 6 | 1 | 5 | Tracing partial replay, idempotency custom |
| CX (4) | 4 | 2 | 2 | Responses API good, rate limit custom |
| OB (7) | 7 | 4 | 3 | Built-in tracing excellent, OTel/SLO custom |
| TE (5) | 5 | 3 | 2 | Mock injection works, simulation custom |
| **Total** | **57** | **32** | **25** | |
...
|----------|-----|------|--------|-------|
| TC | TC-01 | Tool Definition | ⭐⭐⭐⭐⭐ | @function_tool decorator, automatic Pydantic schemas |
| TC | TC-02 | Controllable Automation | ⭐⭐⭐⭐ | human_input_callback, tool wrapping |
| TC | TC-03 | Parallel Execution | ⭐⭐⭐⭐⭐ | Up to 128 tools per agent |
| TC | TC-04 | Error Handling | ⭐⭐⭐⭐ | Automatic error catching, LLM recovery |
| TC | TC-05 | Argument Validation | ⭐⭐⭐⭐⭐ | Native Pydantic integration |
| HI | HI-01 | Interrupt API | ⭐⭐⭐⭐ | human_input_callback, state serialization |
| HI | HI-02 | State Manipulation | ⭐⭐⭐ | Sessions allow state editing |
| HI | HI-03 | Resume Control | ⭐⭐⭐⭐ | Approval/rejection via callbacks |
| DU | DU-01 | State Persistence | ⭐⭐⭐⭐ | Sessions API |
| DU | DU-02 | Process Resume | ⭐⭐⭐⭐ | Session restoration |
| DU | DU-03 | HITL Persistence | ⭐⭐⭐ | Sessions + state serialization |
| DU | DU-04 | Storage Options | ⭐⭐⭐⭐⭐ | SQLite/SQLAlchemy/Dapr/Hosted |
| ME | ME-01 | Short-term Memory | ⭐⭐⭐⭐ | Conversations API |
| ME | ME-02 | Long-term Memory | ⭐⭐⭐⭐ | Sessions + Storage |
| ME | ME-03 | Semantic Search | ⭐⭐⭐⭐ | File Search (RAG) built-in |
| ME | ME-06 | Auto Extraction | ⭐⭐⭐ | Context Summarization |
| MA | MA-01 | Multiple Agent Definition | ⭐⭐⭐⭐⭐ | Agent class, clean API |
| MA | MA-02 | Delegation | ⭐⭐⭐⭐⭐ | Native handoff() function |
| MA | MA-03 | Hierarchical Process | ⭐⭐⭐⭐ | Agent-as-tool pattern |
| MA | MA-04 | Routing | ⭐⭐⭐⭐ | Handoff conditions, flexible |
| GV | GV-01 | Destructive Operation Gate | ⭐⭐⭐⭐ | Guardrails + approval |
| GV | GV-03 | Policy as Code | ⭐⭐⭐ | Guardrail classes |
| CX | CX-03 | Async Job | ⭐⭐⭐⭐ | Responses API background=true |
| OB | OB-01 | Trace | ⭐⭐⭐⭐⭐ | Built-in, enabled by default |
| OB | OB-02 | Token Consumption | ⭐⭐⭐⭐⭐ | request_usage_entries |
| OB | OB-03 | Log Output | ⭐⭐⭐⭐ | Trace spans |
| OB | OB-04 | External Integration | ⭐⭐⭐⭐ | Datadog/Langfuse/Agenta |
| TE | TE-01 | Unit Test / Mocking | ⭐⭐⭐⭐ | model_settings injection |
| TE | TE-02 | State Injection | ⭐⭐⭐ | Session restoration |
| TE | TE-05 | Evaluation Hooks | ⭐⭐⭐ | OpenAI Evals integration |
...
|----------|-----|------|--------|-------|---------------------|
| HI | HI-04 | Timeout | ⭐⭐ | Requires custom implementation | 06_hitl_state.py |
| HI | HI-05 | Notification | ⭐ | No built-in notification | 06_hitl_state.py |
| DU | DU-05 | Cleanup (TTL) | ⭐ | No auto-cleanup | 09_session_production.py |
| DU | DU-06 | Concurrent Access | ⭐⭐ | Requires custom locking | 09_session_production.py |
| ME | ME-04 | Memory API | ⭐⭐ | Limited CRUD API | 12_memory_context.py |
| ME | ME-05 | Agent Autonomous Management | ⭐ | No LangMem equivalent | 12_memory_context.py |
| ME | ME-07 | Memory Cleanup (TTL) | ⭐ | No native TTL | 12_memory_context.py |
| ME | ME-08 | Embedding Cost | ⭐⭐⭐ | token_usage available | 12_memory_context.py |
| MA | MA-05 | Shared Memory | ⭐⭐⭐ | Custom implementation needed | 14_multiagent_orchestration.py |
| GV | GV-02 | Least Privilege / Scope | ⭐⭐ | No native permission system | 15_governance_guardrails.py |
| GV | GV-04 | PII / Redaction | ⭐ | No native redaction | 16_governance_audit.py |
| GV | GV-05 | Tenant / Purpose Binding | ⭐ | No native binding | 16_governance_audit.py |
| GV | GV-06 | Audit Trail Completeness | ⭐⭐⭐ | Tracing partial | 16_governance_audit.py |
| DR | DR-01 | Replay | ⭐⭐ | Tracing partial, no LLM cache | 17_determinism_replay.py |
| DR | DR-02 | Evidence Reference | ⭐⭐⭐ | Trace spans available | 17_determinism_replay.py |
| DR | DR-03 | Non-determinism Isolation | ⭐⭐ | seed parameter limited | 17_determinism_replay.py |
| DR | DR-04 | Idempotency | ⭐ | No native support | 18_determinism_recovery.py |
| DR | DR-05 | Plan Diff | ⭐ | No native diff | 18_determinism_recovery.py |
| DR | DR-06 | Failure Recovery | ⭐⭐ | Sessions enable partial recovery | 18_determinism_recovery.py |
| CX | CX-01 | Auth / Credential Management | ⭐⭐⭐ | API key only | 19_connectors_streaming.py |
| CX | CX-02 | Rate Limit / Retry | ⭐⭐ | Some auto-retry, no rate limiting | 19_connectors_streaming.py |
| CX | CX-04 | State Migration | ⭐⭐ | No migration support | 20_connectors_responses.py |
| OB | OB-05 | OTel Compliance | ⭐⭐ | No native OpenTelemetry | 22_observability_integration.py |
...
| TE | TE-03 | Simulation / User Emulation | ⭐⭐ | No native simulation | 25_testing_evaluation.py |
| TE | TE-04 | Dry Run / Sandbox Mode | ⭐⭐ | No native dry run | 25_testing_evaluation.py |
...
| 03_tool_execution.py | TC | TC-03, TC-04, TC-05: Parallel, errors, validation |
| 04_tool_control.py | TC | TC-02: Controllable automation |
| 05_hitl_approval.py | HI | HI-01, HI-03: Approval flow |
| 06_hitl_state.py | HI | HI-02, HI-04, HI-05: State, timeout, notification |
| 07_session_basic.py | DU | DU-01, DU-02: Sessions |
| 08_session_backends.py | DU | DU-03, DU-04: Storage backends |
| 09_session_production.py | DU | DU-05, DU-06: Cleanup, concurrency |
| 10_memory_conversation.py | ME | ME-01, ME-02: Conversation memory |
| 11_memory_filesearch.py | ME | ME-03: File Search / RAG |
| 12_memory_context.py | ME | ME-04 ~ ME-08: Context management |
| 13_multiagent_handoff.py | MA | MA-01, MA-02: Native handoffs |
| 14_multiagent_orchestration.py | MA | MA-03, MA-04, MA-05: Orchestration |
| 15_governance_guardrails.py | GV | GV-01, GV-02, GV-03: Guardrails |
| 16_governance_audit.py | GV | GV-04, GV-05, GV-06: Audit trail |
| 17_determinism_replay.py | DR | DR-01, DR-02, DR-03: Replay |
| 18_determinism_recovery.py | DR | DR-04, DR-05, DR-06: Recovery |
| 19_connectors_streaming.py | CX | CX-01, CX-02: Auth, rate limiting |
| 20_connectors_responses.py | CX | CX-03, CX-04: Responses API |
| 21_observability_tracing.py | OB | OB-01, OB-02, OB-03: Tracing |
| 22_observability_integration.py | OB | OB-04, OB-05: External integration |
| 23_observability_guard.py | OB | OB-06, OB-07: SLO, cost guard |
| 24_testing_mock.py | TE | TE-01, TE-02: Mocking |
| 25_testing_evaluation.py | TE | TE-03, TE-04, TE-05: Evaluation |
